...
def get_data(config_path):
    ...
    print(f"source_download_dirs: {source_download_dirs}")
    print(f"local_data_dirs: {local_data_dirs}")


    for source_download_dir, local_data_dir in tqdm(zip(source_download_dirs, local_data_dirs), total=3, desc="list of folders", colour="red"):
...
if __name__ == '__main__':
    ...
    try:
        ...
        logging.info("<<<<< stage 01 complete and all the data is saved in local <<<<<\n")
